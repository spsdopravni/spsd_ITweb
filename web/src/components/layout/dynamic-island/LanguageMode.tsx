    ...
    <div className="h-full flex flex-col">
      <div className="px-3 sm:px-5 py-2.5 sm:py-3 border-b border-white/10">
        <div className="flex items-center gap-2 sm:gap-3">
          <Globe className="w-3.5 sm:w-4 h-3.5 sm:h-4 text-blue-400 flex-shrink-0" />
          <span className="text-white text-xs sm:text-sm font-medium">{t('nav.selectLanguage') || 'Vyberte jazyk'}</span>
          <button
